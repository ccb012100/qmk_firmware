...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_109(
        ...
        MT(MOD_MEH,KC_GRV),     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,                     KC_7,           KC_8,           KC_9,           KC_0,     KC_MINS,  KC_EQL,     MT(MOD_MEH,KC_BSPC),    KC_INS,   KC_HOME,  KC_PGUP,  KC_NUM,   KC_PSLS,  KC_PAST,  KC_PMNS,
    ...
    [WIN_BASE] = LAYOUT_ansi_109(
        KC_ESC,                 KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,                    KC_F7,          KC_F8,          KC_F9,          KC_F10,   KC_F11,   KC_F12,     KC_MPLY,                KC_PSCR,  KC_SCRL,  RM_TOGG,  KC_F13,   KC_F14,   KC_F15,   KC_F16,
        KC_GRV,                 KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,                     KC_7,           KC_8,           KC_9,           KC_0,     KC_MINS,  KC_EQL,     MT(MOD_MEH,KC_BSPC),    KC_INS,   KC_HOME,  KC_PGUP,  KC_NUM,   KC_PSLS,  KC_PAST,  KC_PMNS,
        KC_TAB,                 KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,                     KC_U,           KC_I,           KC_O,           KC_P,     KC_LBRC,  KC_RBRC,    KC_BSLS,                KC_DEL,   KC_END,   KC_PGDN,  KC_P7,    KC_P8,    KC_P9,

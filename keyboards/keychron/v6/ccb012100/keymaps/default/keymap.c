...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_109(
        MT(MOD_MEH,KC_GRAVE),   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,                    KC_F7,          KC_F8,          KC_F9,          KC_F10,   KC_F11,   KC_F12,     KC_MUTE,  KC_PSCR,  KC_MPLY,  RM_TOGG,  KC_F13,   KC_F14,   KC_F15,   KC_F16,
        ...
        KC_LCTL,                KC_LCMD,  KC_LOPT,                                MT(MOD_RCTL, KC_SPACE),                                                   KC_RCMD,  KC_ROPT,  KC_F17,     KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,              KC_PDOT,  KC_PENT),
    [WIN_BASE] = LAYOUT_ansi_109(
        ...
        KC_ESC,                 KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,                     KC_J,           KC_K,           KC_L,           KC_SCLN,  KC_QUOT,              KC_ENT,                                 KC_P4,    KC_P5,    KC_P6,    KC_PPLS,
        KC_LSFT,                          KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,                     KC_N,           KC_M,           KC_COMM,        KC_DOT,   KC_SLSH,              KC_RSFT,            KC_UP,              KC_P1,    KC_P2,    KC_P3,
        KC_LCTL,                KC_LWIN,  KC_LALT,                                MT(MOD_RCTL, KC_SPACE),                                                   KC_RALT,  KC_RWIN,  KC_MENU,    KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,              KC_PDOT,  KC_PENT),
    [NAV] = LAYOUT_ansi_109(

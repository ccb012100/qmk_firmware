...
/* IMPORTANT!
 * The first 4 layers must remain:
 *
 *  [0] MAC_BASE
 *  [1] MAC_FN
 *  [2] WIN_BASE
 *  [3] WIN_FN
 *
 * The Keychron setup maps the toggle switches on the keyboard case to those layer positions.
*/
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_BASE] = LAYOUT_ansi_100(
        KC_ESC,   KC_F1,        KC_F2,    KC_F3,    KC_F4,      KC_F5,    KC_F6,    KC_F7,      KC_F8,    KC_F9,    KC_F10,     KC_F11,     KC_F12,     LT(WIN_FN, KC_MPLY),    KC_DEL,   KC_HOME,  KC_END,   KC_PGUP,  KC_PGDN,
        ...
        KC_LWIN,  KC_MEH,       KC_LALT,                                LCTL_T(KC_SPC),                 KC_RALT,  KC_RCTL,      KC_MEH,                             KC_LEFT,    KC_DOWN,  KC_RGHT,  KC_P0,    KC_PDOT),
    [MAC_BASE] = LAYOUT_ansi_100(
        KC_ESC,   KC_BRID,      KC_BRIU,  KC_MCTL,  KC_LPAD,    RGB_VAD,  RGB_VAI,  KC_MPRV,    KC_MPLY,  KC_MNXT,  KC_MUTE,    KC_VOLD,    KC_VOLU,    LT(MAC_FN, KC_MPLY),    KC_DEL,   KC_HOME,  KC_END,   KC_PGUP,  KC_PGDN,
        KC_GRV,   KC_1,         KC_2,     KC_3,     KC_4,       KC_5,     KC_6,     KC_7,       KC_8,     KC_9,     KC_0,       KC_MINS,    KC_EQL,     KC_BSPC,                KC_NUM,   KC_PSLS,  KC_PAST,  KC_PMNS,
        KC_TAB,   KC_Q,         KC_W,     KC_E,     KC_R,       KC_T,     KC_Y,     KC_U,       KC_I,     KC_O,     KC_P,       KC_LBRC,    KC_RBRC,    KC_BSLS,                KC_P7,    KC_P8,    KC_P9,    KC_PPLS,
        KC_CAPS,  KC_A,         KC_S,     KC_D,     KC_F,       KC_G,     KC_H,     KC_J,       KC_K,     KC_L,     KC_SCLN,    KC_QUOT,                KC_ENT,                 KC_P4,    KC_P5,    KC_P6,
        KC_LSFT,  KC_Z,         KC_X,     KC_C,       KC_V,     KC_B,     KC_N,     KC_M,       KC_COMM,  KC_DOT,   KC_SLSH,                            KC_RSFT,    KC_UP,      KC_P1,    KC_P2,    KC_P3,    KC_PENT,
        KC_LCMMD, KC_MEH,       KC_LOPTN,                               LCTL_T(KC_SPC),                 KC_ROPTN, KC_RCMMD,     KC_MEH,                             KC_LEFT,    KC_DOWN,  KC_RGHT,  KC_P0,    KC_PDOT),
    [WIN_FN] = LAYOUT_ansi_100(
        ...
        _______,  RGB_MOD,      RGB_VAI,  RGB_HUI,  RGB_SAI,    RGB_SPI,  BAT_LVL,  NK_TOGG,    _______,  _______,  _______,    _______,                _______,                _______,  _______,  _______,

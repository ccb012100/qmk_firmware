...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ergodox_pretty(
        MT(MOD_MEH,KC_GRAVE),   KC_1,       KC_2,       KC_3,       KC_4,       KC_5,       KC_MPLY,    /* split */     KC_PSCR,    KC_6,           KC_7,           KC_8,           KC_9,           KC_0,       KC_MINUS,
        KC_TAB,                 KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       KC_VOLU,    /* split */     QK_AREP,    KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,       MT(MOD_MEH,KC_EQUAL),
        KC_ESC,                 KC_A,       KC_S,       KC_D,       KC_F,       KC_G,                   /* split */                 KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,    KC_QUOTE,
        KC_LEFT_SHIFT,          KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_VOLD,    /* split */     QK_REP,     KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,   KC_RIGHT_SHIFT,
        KC_F17,                 KC_MEH,     RGB_TOG,    KC_LGUI,    KC_LALT,                            /* split */                                 KC_RALT,        KC_RGUI,        KC_APP,         KC_MEH,     KC_F18,
    ...
    [RIGHT] = LAYOUT_ergodox_pretty(
        ...
        KC_TRNS,        KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    /* split */     KC_TRNS,    KC_PIPE,        KC_LCBR,        KC_RCBR,        KC_LBRC,        KC_RBRC,    KC_F12,
